...
"""Verify that starting supernodecoin with -h works as expected."""
import subprocess

from test_framework.test_framework import SupernodeCoinTestFramework
from test_framework.util import assert_equal

class HelpTest(SupernodeCoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start supernodecoin with -? for help text")
        ...
        self.log.info("Start supernodecoin with -version for version information")
