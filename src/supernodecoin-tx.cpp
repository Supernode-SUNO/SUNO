...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("SupernodeCoin supernodecoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  supernodecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded supernodecoin transaction") + "\n" +
                               "  supernodecoin-tx [options] -create [commands]   " + _("Create hex-encoded supernodecoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded supernodecoin transaction
