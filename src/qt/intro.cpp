...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", DEFAULT_CHOOSE_DATADIR)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Supernode Coin"),
     ...
     * override -datadir in the supernodecoin.conf file in the default data directory
     * (to be consistent with supernodecoind behavior)
     */
