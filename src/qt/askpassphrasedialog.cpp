...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            SupernodeCoinGUI* window = static_cast<SupernodeCoinGUI*>(parentWidget());
...
{
    SupernodeCoinGUI* gui = static_cast<SupernodeCoinGUI*>(parentWidget());
...
{
    hide();
    static_cast<SupernodeCoinGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("SupernodeCoin will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your SUNOs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
