...
/* SupernodeCoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "SupernodeCoin"
#define QAPP_ORG_DOMAIN "supernodecoin.org"
#define QAPP_APP_NAME_DEFAULT "SupernodeCoin-Qt"
#define QAPP_APP_NAME_TESTNET "SupernodeCoin-Qt-testnet"
