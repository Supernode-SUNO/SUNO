...
#include "qt/supernodecoin/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/supernodecoin/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(SupernodeCoinGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
           ...
           ui->labelNumber_UnspendableSUNO,
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendableSUNO,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendableSUNO,
    ...
    connect(ui->pushButton_UnspendableSUNO, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendableSUNO);});
    ...
    if (parent)
        connect(parent, &SupernodeCoinGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
