...
#include "qt/supernodecoin/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/supernodecoin/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(SupernodeCoinGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Supernode Coin RPC console.") + "<br>" +
