...
#include "qt/supernodecoin/settings/settingsnetworkwidget.h"
#include "qt/supernodecoin/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/supernodecoin/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(SupernodeCoinGUI* _window, QWidget *parent) :
