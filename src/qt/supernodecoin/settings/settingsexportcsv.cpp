...
#include "qt/supernodecoin/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(SupernodeCoinGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("SupernodeCoin_tx_csv_export(*.csv)") : tr("SupernodeCoin_addresses_csv_export(*.csv)"),
                                        nullptr);
