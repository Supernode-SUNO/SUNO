...
#include "qt/supernodecoin/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/supernodecoin/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(SupernodeCoinGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to SupernodeCoinGUI::handleRestart()
