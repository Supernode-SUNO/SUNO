...
#include "qt/supernodecoin/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/supernodecoin/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(SupernodeCoinGUI* _window, QWidget *parent) :
