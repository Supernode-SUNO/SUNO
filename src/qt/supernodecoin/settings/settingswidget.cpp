...
#include "qt/supernodecoin/settings/forms/ui_settingswidget.h"
...
SettingsWidget::SettingsWidget(SupernodeCoinGUI* parent) :
    PWidget(parent),
    ui(new Ui::SettingsWidget)
{
    ...
    connect(ui->pushButtonHelp1, &QPushButton::clicked, window, &SupernodeCoinGUI::openFAQ);
