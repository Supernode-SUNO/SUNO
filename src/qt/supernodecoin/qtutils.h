...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, SupernodeCoinGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, SupernodeCoinGUI* gui, double posX = 3);
