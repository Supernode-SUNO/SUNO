...
#include <QWidget>
#include <QString>
#include "qt/supernodecoin/prunnable.h"
...
class PWidget : public QWidget, public Runnable, public Translator
{
    Q_OBJECT
public:
    explicit PWidget(SupernodeCoinGUI* _window = nullptr, QWidget *parent = nullptr);
    explicit PWidget(PWidget *parent = nullptr);

    void setClientModel(ClientModel* model);
    void setWalletModel(WalletModel* model);

    SupernodeCoinGUI* getWindow() { return this->window; }
...
protected:
    SupernodeCoinGUI* window = nullptr;
