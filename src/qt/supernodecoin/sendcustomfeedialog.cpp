...
#include "qt/supernodecoin/sendcustomfeedialog.h"
#include "qt/supernodecoin/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(SupernodeCoinGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &SupernodeCoinGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
