...
#include "qt/supernodecoin/forms/ui_addresseswidget.h"
#include "qt/supernodecoin/addresslabelrow.h"
#include "qt/supernodecoin/addnewaddressdialog.h"
#include "qt/supernodecoin/tooltipmenu.h"
...
AddressesWidget::AddressesWidget(SupernodeCoinGUI* parent) :
    PWidget(parent),
...
void AddressesWidget::onStoreContactClicked()
{
    if (walletModel) {
        ...
        CTxDestination sunoAdd = DecodeDestination(address.toUtf8().constData(), isStakingAddress);
        ...
        if (walletModel->updateAddressBookLabels(sunoAdd, label.toUtf8().constData(),
