...
#ifndef SupernodeCoin_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define SupernodeCoin_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //SupernodeCoin_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
