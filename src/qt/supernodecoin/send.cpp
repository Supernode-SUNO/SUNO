...
#include "qt/supernodecoin/forms/ui_send.h"
#include "qt/supernodecoin/addnewcontactdialog.h"
#include "qt/supernodecoin/qtutils.h"
#include "qt/supernodecoin/sendchangeaddressdialog.h"
#include "qt/supernodecoin/optionbutton.h"
#include "qt/supernodecoin/sendconfirmdialog.h"
#include "qt/supernodecoin/myaddressrow.h"
#include "qt/supernodecoin/guitransactionsutils.h"
...
SendWidget::SendWidget(SupernodeCoinGUI* parent) :
    PWidget(parent),
    ui(new Ui::send),
    ...
    btnContacts(new QPushButton())
{
    ...
    setCssProperty(coinIcon, "coin-icon-suno");
...
void SendWidget::onContactMultiClicked()
{
    if (focusedEntry) {
        ...
        CTxDestination sunoAdd = DecodeDestination(address.toStdString());
        if (walletModel->isMine(sunoAdd)) {
        ...
        if (dialog->res) {
            ...
            if (walletModel->updateAddressBookLabels(sunoAdd, dialog->getLabel().toStdString(),
                    AddressBook::AddressBookPurpose::SEND)) {
