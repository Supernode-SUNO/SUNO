...
/** Utility functions used by the SupernodeCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render SupernodeCoin addresses in monospace font
...
// Parse "supernodecoin:" URI into recipient object, return true on successful parsing
