...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(SUNO);
    unitlist.append(mSUNO);
    unitlist.append(uSUNO);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case SUNO:
        return QString("Supernode coin");
    case mSUNO:
        return QString("mSupernode coin");
    case uSUNO:
        return QString::fromUtf8("uSupernode coin");
    default:
        return QString("???");
    }
}
