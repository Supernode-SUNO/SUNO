...
#ifndef SupernodeCoin_QT_WALLETMODEL_H
#define SupernodeCoin_QT_WALLETMODEL_H
...
/** Interface to SupernodeCoin wallet from Qt view code. */
...
#endif // SupernodeCoin_QT_WALLETMODEL_H
