...
static const CAmount DEFAULT_MIN_STAKE_SPLIT_THRESHOLD = 50 * COIN;
...
enum WalletFeature {
    ...
    FEATURE_PRE_SupernodeCoin = 61000, // inherited version..
...
public:
    ...
    /// Get 10000 SUNO output and keys which can be used for the Masternode
