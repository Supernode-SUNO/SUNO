...
The script [extract-osx-sdk.sh](https://github.com/supernodecoin-project/supernodecoin/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
supernodecoin/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/supernodecoin-project/supernodecoin/blob/master/doc/README_osx.md) for troubleshooting tips.
