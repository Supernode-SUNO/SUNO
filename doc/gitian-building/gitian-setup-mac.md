...
The build script we'll be using is contained in the SupernodeCoin github repository ([contrib/gitian-build.py](https://github.com/supernodecoin-project/supernodecoin/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the SupernodeCoin repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/SupernodeCoin-Project/SupernodeCoin/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, supernodecoin-detached-sigs, and supernodecoin GitHub repos.
