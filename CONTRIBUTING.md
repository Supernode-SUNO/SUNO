Contributing to SupernodeCoin
============================

The SupernodeCoin project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/supernodecoin-project/supernodecoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the SupernodeCoin project, and is not to be
confused with overall SupernodeCoin Network Protocol consensus changes.

Whether a pull request is merged into SupernodeCoin rests with the project merge
...
Patches that change SupernodeCoin consensus rules are considerably more involved than
...
Where a patchset proposes to change the SupernodeCoin consensus, it must have been
...
The project leader is the release manager for each SupernodeCoin release.
